...
type RaceTab = "Data" | "Testing" | "Availability" | "Schedule" | "Live Strategy";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (requestedRace) {
      ...
      if (
        requestedTab &&
        ["Data", "Testing", "Availability", "Schedule", "Live Strategy"].includes(requestedTab)
      ) {
    ...
    if (savedRoute) {
      try {
        ...
        if (route?.race) {
          ...
          if (
            route.tab &&
            ["Data", "Testing", "Availability", "Schedule", "Live Strategy"].includes(route.tab)
          ) {
    ...
    return (
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {cards.map(([title, value, sub]) => (
          <div
            key={title}
            className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl p-5"
          >
  ...
  function appShell(content: React.ReactNode) {
    ...
    return (
      <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.18),transparent_32%),radial-gradient(circle_at_90%_10%,rgba(56,189,248,0.08),transparent_25%),linear-gradient(180deg,#05070c_0%,#09090b_52%,#030305_100%)] text-white">
        <aside className="fixed left-0 top-0 z-20 flex h-screen w-56 flex-col border-r border-white/10 bg-black/55 p-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
          <div className="mb-5 rounded-[1.65rem] border border-white/10 bg-gradient-to-br from-zinc-900/90 to-black p-4 shadow-2xl shadow-black/40">
            <div className="flex items-center gap-3">
              <img
                src="/stintsync-mark.png"
                alt="StintSync mark"
                className="h-12 w-12 shrink-0 object-contain drop-shadow-[0_0_14px_rgba(37,99,235,0.35)]"
              />
          ...
          <div className="mt-4 rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-3 shadow-2xl shadow-black/25">
            {userId ? (
              <div className="space-y-3">
                ...
                <button
                  onClick={signOut}
                  className="w-full rounded-2xl border border-red-900/60 bg-red-950/60 px-3 py-2 text-sm font-bold text-red-100 transition hover:bg-red-700 hover:text-white"
                >
                  Logout
                </button>
              </div>
              ...
              <div className="space-y-3">
                ...
                <a
                  href="/login"
                  className="block w-full rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-3 py-2 text-center text-sm font-bold transition hover:from-blue-500 hover:to-sky-400"
                >
                  Login
                </a>
              </div>
        ...
        <section className="ml-56 min-h-screen overflow-x-hidden p-8">
          {content}
        </section>

        {finishedPopup && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 p-6">
            <div className="max-w-md rounded-[1.65rem] border border-green-700 bg-zinc-900 p-8 text-center shadow-2xl shadow-black/25">
        ...
        {noteModalText !== null && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 p-4">
            <div className="w-full max-w-lg rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl shadow-black/25">
              ...
              <button
                ...
                className="mt-5 rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-4 py-2 font-bold hover:from-blue-500 hover:to-sky-400"
              >
                Close
              </button>
            </div>
        ...
        {deleteConfirm && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 p-4">
            <div className="w-full max-w-md rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl shadow-black/25">
  ...
  const panelClass =
    "rounded-[1.65rem] border border-white/10 bg-zinc-900/72 shadow-2xl shadow-black/25 backdrop-blur-xl";
  const softPanelClass =
    "rounded-[1.65rem] border border-white/10 bg-black/30 shadow-2xl shadow-black/25 backdrop-blur-xl";
  const sectionHeaderLabel =
    "text-xs font-black uppercase tracking-[0.32em] text-blue-300";
  const primaryButtonClass =
    "rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 font-black text-white shadow-lg shadow-blue-950/40 ring-1 ring-white/10 transition hover:-translate-y-0.5 hover:from-blue-500 hover:to-sky-400";
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          {[
            ...
            <div
              key={step}
              className="relative min-h-[185px] overflow-hidden rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl shadow-lg"
              style={{
            ...
            >
              ...
              <div className="relative p-5">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-2xl bg-blue-600 text-lg font-black">
                  {step}
                </div>
        ...
        {showAddRace && (
          <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            ...
            <div className="grid gap-4 xl:grid-cols-4">
              <label className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Spa 24"
                  className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                />
              </label>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <button
                onClick={createRace}
                className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-6 py-3 font-bold shadow-lg shadow-blue-950/40 transition hover:from-blue-500 hover:to-sky-400"
              >
                Create Race
              </button>
              <button
        ...
        <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
          ...
          {races.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-zinc-600 bg-zinc-950 p-10 text-center">
              ...
              {[...races]
                ...
                .map((race: any) => {
                  ...
                  return (
                    <div
                      key={race.id}
                      className="group overflow-hidden rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl shadow-lg transition hover:-translate-y-0.5 hover:border-blue-900 hover:bg-black"
                    >
                      {editingRaceId === race.id ? (
                        <div className="p-5">
                          <div className="mb-4 rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-4">
                          ...
                          <div className="grid gap-3">
                            <label className="space-y-2">
                              ...
                              <input
                                ...
                                className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                              />
                            </label>
                        ...
                        <div className="flex h-full flex-col justify-between gap-5 p-5">
                          <button
                            ...
                            className="text-left"
                          >
                            <div className="relative mb-5 h-40 overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-blue-950/80 to-zinc-900">
                              {trackImage && (
                                <img
                                  src={trackImage}
                                  alt=""
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                              <div>
                                <h4 className="text-2xl font-black tracking-tight transition group-hover:text-blue-300">
                                  {race.name}
                                </h4>
                                <p className="mt-1 text-sm text-zinc-400">
                              ...
                              <span className="rounded-full border border-blue-900 bg-blue-950/50 px-3 py-1 text-xs font-bold uppercase tracking-wide text-blue-300">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-4 py-2 font-bold transition hover:from-blue-500 hover:to-sky-400"
                            >
                              Open
                            </button>
                            {canEditRace(race) ? (
  ...
  function teamsPage() {
    ...
    if (selectedTeam) {
      return appShell(
        <div className="mx-auto max-w-7xl space-y-6">
          <section className="overflow-hidden rounded-[1.65rem] border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black p-6 shadow-2xl">
          ...
          {editingTeamId === selectedTeam.id ? (
            <section className="rounded-[1.65rem] border border-yellow-800/60 bg-yellow-950/20 p-6 shadow-2xl shadow-black/25">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-2xl border border-zinc-600 bg-zinc-900 px-4 py-3 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                />
                <button
          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            {[
              ...
              <div
                key={label}
                className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-5 shadow-2xl shadow-black/25"
              >
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {selectedMembers.map((member: any) => {
                    ...
                    return (
                      <div
                        key={member.user_id}
                        className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl p-4"
                      >
              ...
              <div className="mt-5 grid gap-3">
                {selectedIsAdmin ? (
                  <button
                    ...
                    className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 text-left font-bold transition hover:from-blue-500 hover:to-sky-400"
                  >
          ...
          <section className="grid gap-6 xl:grid-cols-3">
            <div className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
              ...
              <div className="mt-5 space-y-3">
                {selectedTeamRaces.slice(0, 5).map((race: any) => (
                  <button
                    ...
                    className="block w-full rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl p-4 text-left transition hover:border-blue-900"
                  >
        ...
        <div className="grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
          <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={createTeam}
                className="w-full rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-6 py-3 font-bold shadow-lg shadow-blue-950/40 transition hover:from-blue-500 hover:to-sky-400"
              >
                Create Team
              </button>
            </div>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              {teams.map((team: any) => {
                ...
                return (
                  <div
                    key={team.id}
                    className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5 shadow-lg transition hover:border-blue-900/70"
                  >
                    ...
                    <div className="mt-5 rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-4">
  ...
  function testingLibraryPage() {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[1.65rem] border border-white/10 bg-black/35 p-5 shadow-2xl shadow-black/25 backdrop-blur-xl">
        ...
        <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
                    ...
                    {comparedTests.slice(0, 4).map((test: any) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="rounded-xl bg-blue-700 px-3 py-2 text-xs font-bold hover:bg-blue-600"
                        >
                          Use as Save
                        </button>
                      </div>
            ...
            <div>
              <div className="mb-3 flex flex-wrap items-center gap-2 text-sm">
                <button
                  ...
                  className={`rounded-full px-3 py-1 font-bold transition ${selectedTestFolderId === "all" ? "bg-blue-600 text-white" : "bg-zinc-800 text-zinc-300 hover:bg-zinc-700"}`}
                >
                  Tests
                </button>
                  ...
                  <div
                    ...
                    className={`rounded-[1.65rem] border p-5 transition ${
                      selectedTestFolderId === folder.id
                        ...
                        : "border-zinc-800 bg-zinc-950 hover:border-blue-900/70"
                    }`}
                  >
                    {editingTestFolderId === folder.id ? (
                      <div className="space-y-3">
                        <input
                          ...
                          className="w-full rounded-xl border border-white/10 bg-white/[0.07] px-3 py-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                        />
                      ...
                      <>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          <button
                            onClick={() => setSelectedTestFolderId(folder.id)}
                            className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-4 py-2 text-sm font-bold hover:from-blue-500 hover:to-sky-400"
                          >
                            Open
                          </button>
                          {canEditTestFolder(folder) ? (
                            <>
                              <button
                                ...
                                className="rounded-2xl bg-blue-700 px-4 py-2 text-sm font-bold text-white hover:bg-blue-600"
                              >
                                Share
                              </button>
                              <button
              ...
              <div className="grid gap-4 2xl:grid-cols-2">
                {visibleTests.map((test: any) => (
                  <div
                    ...
                    className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5"
                  >
                    <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="rounded-full border border-blue-900 bg-blue-950/60 px-3 py-1 text-xs font-bold text-blue-200">
                          {test.weather || "Sunny"}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid gap-3 sm:grid-cols-4">
                      {[
                        ...
                        <div
                          key={label}
                          className="rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-3"
                        >
                          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-500">
                            {label}
                          </p>
                    ...
                    <div className="mt-4 flex flex-wrap items-end gap-2">
                      {!canEditSharedItem(test) ? (
                        <span className="rounded-2xl bg-blue-950/50 px-3 py-2 text-xs font-bold uppercase tracking-wide text-blue-200">
                          Team shared
                        </span>
                      ) : null}
                      ...
                      {canEditSharedItem(test) ? (
                        <button
                          ...
                          className="rounded-2xl bg-blue-700 px-4 py-2 text-sm font-bold transition hover:bg-blue-600"
                        >
                          Share
                        </button>
                      ) : null}
        ...
        {sharingLibraryTest && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/75 p-4">
            <div className="w-full max-w-lg rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl">
              <div className="mb-5">
                <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-400">
                  Share Test
                </p>
              ...
              {getInheritedTestFolderTeamId(sharingLibraryTest.folder_id) ? (
                <div className="mb-4 rounded-2xl border border-blue-900 bg-blue-950/30 p-4 text-sm text-blue-100">
              ...
              <label className="block space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition disabled:cursor-not-allowed disabled:opacity-60 focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                >
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <button
                  ...
                  className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 font-bold transition disabled:cursor-not-allowed disabled:opacity-50 hover:from-blue-500 hover:to-sky-400"
                >
                  Save Sharing
                </button>
                <button
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/75 p-4">
            <div className="w-full max-w-lg rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl">
              ...
              <div className="space-y-3">
                ...
                {folderOptions.map((folder: any) => (
                  ...
                  >
                    ...
                    {folder.team_id ||
                    getInheritedTestFolderTeamId(folder.parent_id) ? (
                      <span className="ml-2 rounded-full bg-blue-950/70 px-2 py-1 text-[10px] text-blue-200">
                        Shared
                      </span>
                    ) : null}
                  </button>
              ...
              <button
                ...
                className="mt-5 rounded-2xl bg-zinc-700 px-5 py-3 font-bold transition hover:bg-zinc-600"
              >
                Cancel
              </button>
            </div>
            ...
            <div className="w-full max-w-lg rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <button
                  ...
                  className="rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 font-bold transition hover:from-blue-500 hover:to-sky-400"
                >
                  Save Sharing
                </button>
                <button
        ...
        {showAddLibraryTest && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center overflow-y-auto bg-black/75 p-4">
            <div className="my-8 w-full max-w-5xl rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl">
              ...
              <div className="space-y-6">
                <div className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5">
                  <h4 className="mb-4 text-lg font-bold">Save Location</h4>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-4">
                      <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                        Folder
                      </p>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <span className="flex items-center gap-2 text-sm font-semibold text-zinc-300">
                          ...
                          {(key === "inlap" || key === "outlap") && (
                            <button
                              ...
                              className="flex h-5 w-5 items-center justify-center rounded-full border border-zinc-600 text-xs font-bold text-zinc-300 hover:border-blue-400 hover:text-blue-300"
                            >
                              i
                            </button>
                          )}
                    ...
                    <label className="space-y-2 md:col-span-3">
                      ...
                      <textarea
                        ...
                        className="h-24 w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                      />
                    </label>
                    ...
                    <label className="space-y-2 md:col-span-3">
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition file:mr-4 file:rounded-xl file:border-0 file:bg-blue-600 file:px-4 file:py-2 file:font-bold file:text-white hover:file:bg-blue-500"
                      />
                      <p className="text-xs text-zinc-500">
                        {librarySetupFile
  ...
  function setupsPage() {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
            ...
            <div>
              <div className="mb-3 flex flex-wrap items-center gap-2 text-sm">
                <button
                  ...
                  className={`rounded-full px-3 py-1 font-bold transition ${selectedSetupFolderId === "all" ? "bg-blue-600 text-white" : "bg-zinc-800 text-zinc-300 hover:bg-zinc-700"}`}
                >
                  Setups
                </button>
              ...
              <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
                {childFolders.map((folder: any) => (
                  <div
                    ...
                    className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5 transition hover:border-blue-900/70"
                  >
        ...
        {showAddSetupFile && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center overflow-y-auto bg-black/75 p-4">
            <div className="my-8 w-full max-w-4xl rounded-[1.65rem] border border-zinc-600 bg-zinc-900 p-6 shadow-2xl">
              <div className="mb-6 flex items-start justify-between gap-4">
                <div>
                  <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-400">
                ...
                <div className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <input
                      ...
                      className="rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                    />
                ...
                <div className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5">
                  ...
                  <div className="grid gap-4">
                    ...
                    <textarea
                      ...
                      className="h-28 rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                    />
                  </div>
                </div>
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
          ...
          <div className="overflow-hidden rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl">
                      ...
                      {dayRaces.slice(0, 3).map((race: any) => {
                        ...
                        return (
                          <button
                            ...
                            className={`block h-[42px] w-full border-y border-blue-800/70 bg-blue-700/90 px-2 py-1 text-left shadow-sm transition hover:bg-blue-600 ${multiDayBarClass(position)}`}
                          >
                            {showText ? (
                              <>
                                ...
                                <p className="mt-0.5 truncate text-[10px] text-blue-100/80">
        ...
        {nextRace ? (
          <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-300">
                  Next Up
                </p>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl px-5 py-4">
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                    Countdown
                  </p>
  ...
  function exportsPage() {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="min-w-0 flex-1">
              ...
              <select
                ...
                className="mt-4 w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 font-bold outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
              >
                <option value="" className="bg-zinc-950 text-white">
                  Choose a race
                </option>
        ...
        {!chosenRace ? (
          <section className="rounded-[1.65rem] border border-dashed border-zinc-600 bg-zinc-900 p-10 text-center shadow-2xl shadow-black/25">
          ...
          <>
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                <div
                  key={label}
                  className="rounded-[1.35rem] border border-white/10 bg-zinc-900/70 p-5 shadow-lg shadow-black/20 backdrop-blur-xl"
                >
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                    {label}
                  </p>
            ...
            <section className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
              <div className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
                ...
                <div className="mt-5 grid gap-4">
                  ...
                  <button
                    onClick={openPrintableSchedule}
                    className="rounded-[1.35rem] border border-blue-800 bg-blue-950/40 p-5 text-left transition hover:bg-blue-900/50"
                  >
                    <p className="text-xl font-black text-blue-200">Print / Save as PDF</p>
                    <p className="mt-2 text-sm leading-6 text-zinc-400">
        ...
        <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            ...
            <div className="mt-5 grid gap-4">
              ...
              <div className="rounded-2xl border border-blue-900 bg-blue-950/25 p-4 text-sm leading-6 text-blue-100">
                  ...
                  >
                    ...
                    <div className="mt-5 grid gap-3 md:grid-cols-3">
                      {[
                        ...
                        <div
                          key={label}
                          className="rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-4"
                        >
                          <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                            {label}
                          </p>
  ...
  function settingsPage() {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[1.65rem] border border-blue-800 bg-blue-950/30 p-6 shadow-2xl shadow-black/25">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-300">
                Settings Tools
              ...
              <p className="mt-2 text-sm text-blue-100/80">
                If you can see this blue Settings Tools box, the updated
          ...
          <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            ...
            <div className="mt-5 grid gap-3">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <button
                  onClick={() => refreshAll(true)}
                  className="rounded-2xl bg-blue-700 px-5 py-3 font-bold transition hover:bg-blue-600"
                >
                  Refresh Cloud Data
                </button>
                <button
  ...
  function placeholderPage(title: string) {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[1.65rem] border border-white/10 bg-black/35 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
  ...
  function requestsPage() {
    ...
    function requestBadgeClass(status: string | null | undefined) {
      ...
      if (value === "added")
        return "border-blue-700 bg-blue-950/60 text-blue-200";
              ...
              {adminMode ? (
                <>
                  ...
                  <button
                    ...
                    className="rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 px-3 py-2 text-xs font-bold transition hover:from-blue-500 hover:to-sky-400"
                  >
                    Mark Added
                  </button>
                  <button
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div
              key={label}
              className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 p-5 shadow-xl shadow-black/20"
            >
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                {label}
              </p>
            ...
            <div className="space-y-4">
              ...
              <label className="space-y-2 block">
                ...
                <textarea
                  ...
                  className="h-28 w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                />
              </label>
  ...
  function helpPage() {
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[1.65rem] border border-blue-800 bg-blue-950/25 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          {deepDiveSections.map((section) => (
            <div
              key={section.title}
              className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl"
            >
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
          <div className="rounded-[1.65rem] border border-green-800 bg-green-950/20 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
          ...
          <div className="rounded-[1.65rem] border border-purple-800 bg-purple-950/20 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_0.85fr]">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {quickLinks.map(([page, detail]) => (
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-black/30 p-4 text-left transition hover:border-blue-500/40 hover:bg-white/[0.06]"
                >
                  <div className="flex items-center gap-3">
          ...
          <div className="rounded-[1.65rem] border border-white/10 bg-black/35 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl">
            ...
            <a
              ...
              className="mt-5 block rounded-2xl border border-blue-900/50 bg-blue-950/20 p-4 text-sm font-bold text-blue-200 transition hover:border-blue-500/60 hover:bg-blue-950/35"
            >
  ...
  function raceWorkspace() {
    if (!selectedRace) {
      return appShell(
        <div className="mx-auto max-w-4xl rounded-[1.65rem] border border-white/10 bg-zinc-900/70 p-8 text-center shadow-2xl shadow-black/25">
          ...
          <button
            ...
            className="mt-5 rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 font-bold transition hover:from-blue-500 hover:to-sky-400"
          >
            Go Home
          </button>
        </div>,
    ...
    return appShell(
      <div className="mx-auto max-w-7xl space-y-6">
        <button
          ...
          className="rounded-2xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl px-4 py-2 text-sm font-bold text-blue-300 transition hover:border-blue-700 hover:bg-zinc-800"
        >
          ← Back to Home
        </button>

        <section className="overflow-hidden rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl shadow-2xl">
          <div className="relative min-h-[260px]">
            ...
            <div className="relative flex min-h-[260px] flex-col justify-between gap-8 p-6 lg:p-8">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-300">
                    Race Workspace
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className="rounded-full border border-zinc-600 bg-black/45 px-3 py-1 text-xs font-bold uppercase tracking-wide text-zinc-200">
                      {selectedRace.race_date || "No date"}
                    </span>
                    <span className="rounded-full border border-zinc-600 bg-black/45 px-3 py-1 text-xs font-bold uppercase tracking-wide text-zinc-200">
                      {trackName}
                    </span>
                    <span className="rounded-full border border-blue-900 bg-blue-950/60 px-3 py-1 text-xs font-bold uppercase tracking-wide text-blue-200">
                      {teamName}
                    </span>
                  </div>
                </div>

                <div className="w-full rounded-[1.65rem] border border-blue-900/80 bg-blue-950/60 p-5 text-left shadow-2xl shadow-black/25 backdrop-blur-sm lg:w-[320px]">
              ...
              <div className="grid gap-3 md:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-black/45 p-4 backdrop-blur-sm">
                  ...
                  <p className="mt-2 font-bold text-zinc-100">{trackName}</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-black/45 p-4 backdrop-blur-sm">
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-400">
                    Team
                  </p>
                  <p className="mt-2 font-bold text-zinc-100">{teamName}</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-black/45 p-4 backdrop-blur-sm">
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-400">
                    Active Tab
        ...
        <section className="w-full rounded-[1.65rem] border border-zinc-800 bg-black p-2 shadow-2xl shadow-black/25">
          <div className="grid w-full gap-2 sm:grid-cols-2 xl:grid-cols-5">
            {(["Data", "Testing", "Availability", "Schedule", "Live Strategy"] as RaceTab[]).map(
              (tab) => {
      ...
      <div className="space-y-6">
        <section className={`${panelClass} p-6`}>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="rounded-[1.35rem] border border-blue-900 bg-blue-950/40 p-4 text-sm text-blue-100 lg:w-[340px]">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="rounded-xl border border-blue-500/40 bg-blue-600/20 px-3 py-2 text-xs font-black text-blue-100 hover:bg-blue-600/30"
                >
                  Edit Race Data
                </button>
              </div>
  ...
  function dataTab() {
    ...
    return (
      <section className="w-full rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6">
            <section className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5">
              <div className="mb-5">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <label className="space-y-2 md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
                      />
                    </label>
            ...
            <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-5">
              ...
              {selectedRaceCars.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-zinc-600 bg-zinc-950 p-8 text-center">
                  ...
                  <button
                    onClick={() => setActiveRaceTab("Testing")}
                    className="mt-4 rounded-2xl bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-3 font-bold transition hover:from-blue-500 hover:to-sky-400"
                  >
                    Go to Testing
                  </button>
                </div>
                  ...
                  {selectedRaceCars.map((car: any) => {
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-[1.65rem] border p-5 text-left transition ${
                          isSelected
                            ? "border-blue-400 bg-blue-600/20 shadow-lg shadow-blue-950/30"
                            : "border-zinc-800 bg-zinc-950 hover:border-blue-900/70 hover:bg-zinc-900 disabled:cursor-not-allowed disabled:opacity-60"
                        }`}
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                          ...
                          {isSelected ? (
                            <span className="rounded-full bg-gradient-to-r from-blue-600 to-sky-500 px-3 py-1 text-xs font-black text-white">
                              Using
                            </span>
                          ) : null}
                        </div>
                ...
                <label className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      className="min-w-0 flex-1 rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {timeZoneOptions.map((zone: string) => (
                        <option
                          key={zone}
      ...
      <div className="space-y-6">
        <section className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
          <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl px-4 py-3">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
                Selected Car
              </p>
            ...
            <div className="rounded-[1.65rem] border border-zinc-600 bg-black/35 backdrop-blur-xl p-5">
              ...
              <div className="flex flex-col gap-3">
                <select
                  ...
                  className="min-w-0 flex-1 rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                >
                  <option value="" className="bg-zinc-950 text-white">
                    Choose a saved test
                  </option>
        ...
        <div className="grid items-stretch gap-6 xl:grid-cols-[0.42fr_1.58fr]">
          <section className="flex h-full flex-col rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
            <div className="mb-5">
                    ...
                    {editingRaceCarId === car.id ? (
                      <div className="mt-3 flex flex-wrap gap-2">
                        <input
                          ...
                          className="min-w-[120px] flex-1 rounded-xl border border-white/10 bg-white/[0.07] px-3 py-2 text-sm outline-none focus:border-blue-400"
                        />
                        <button
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className={`rounded-xl px-3 py-1 text-xs font-bold ${compareRaceCarIds.includes(car.id) ? "bg-blue-600 text-white" : "bg-white/[0.08] text-zinc-200 hover:bg-white/[0.12]"}`}
                        >
            ...
            <div className="space-y-5">
              {weatherOptions
                ...
                .map((group) => (
                  <div
                    key={group.weather}
                    className="rounded-[1.65rem] border border-zinc-600 bg-black/35 p-5"
                  >
            ...
            {carTestsForSelected.length === 0 ? (
              ...
              <div className="space-y-5">
                {baselineTestGroups.map((group: any) => (
                  <div
                    key={group.id}
                    className="rounded-[1.65rem] border border-white/10 bg-black/35 p-5"
                  >
                    ...
                    <div className="overflow-x-auto rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl">
  ...
  function availabilityTab() {
    ...
    function availabilityBadgeClass(status: string | null | undefined) {
      ...
      if (value === "Want to Drive")
        return "border-blue-700 bg-blue-950/70 text-blue-200";
      ...
      <section className="space-y-6">
        <div className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
          ...
          <div className="mt-5 grid gap-4 xl:grid-cols-[1fr_1.1fr]">
            <div className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl p-4">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                <label className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 font-bold outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                  >
                    <option value="" className="bg-zinc-950 text-white">
                      Doesn’t matter
                    </option>
            ...
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
              {selectedRaceMembers.map((member: any) => {
                ...
                return (
                  <div
                    key={member.user_id}
                    className={`rounded-2xl border p-4 ${isMe ? "border-blue-800 bg-blue-950/25" : "border-zinc-800 bg-zinc-950"}`}
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
  ...
  function scheduleWarningBadgeClass(kind: string) {
    ...
    if (kind === "Manual override")
      return "border-blue-700 bg-blue-950/70 text-blue-100";
    if (kind === "Completed")
    ...
    return (
      <section className="relative left-1/2 w-[calc(100vw-18rem)] max-w-none -translate-x-1/2 space-y-6">
        ...
        {warningRows.length > 0 ? (
          <section className="rounded-[1.65rem] border border-purple-800 bg-purple-950/20 p-5 shadow-2xl shadow-black/20">
        ...
        <div className="rounded-[1.65rem] border border-white/10 bg-zinc-900/70 backdrop-blur-xl p-6 shadow-2xl shadow-black/25">
          ...
          <div className="mb-5 grid gap-4 xl:grid-cols-[1fr_1fr]">
            <div className="rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl p-4 text-sm text-blue-100">
              <p>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 px-4 py-2 font-bold text-white transition hover:from-blue-500 hover:to-sky-400"
                >
                  Clean Regenerate
                </button>
                <button
          ...
          <div className="w-full overflow-x-auto rounded-2xl border border-zinc-600 bg-black/35 backdrop-blur-xl">
                    ...
                    >
                      ...
                      <td className={`${scheduleTd} whitespace-nowrap`}>
                        <select
                          ...
                          className="w-full rounded-xl border border-white/10 bg-white/[0.07] px-2 py-2 font-semibold outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                        >
                          {selectedRaceMembers.map((member: any) => (
                            <option
                              key={member.user_id}
                      ...
                      >
                        <input
                          ...
                          placeholder="+ sec"
                          className="w-full rounded-xl border border-white/10 bg-white/[0.07] px-2 py-2 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
                        />
                      </td>
