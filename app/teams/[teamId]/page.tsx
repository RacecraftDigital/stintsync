      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black p-6 shadow-2xl">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <a href={`/?page=Teams&team=${teamId}`} className="text-sm font-semibold text-blue-400 hover:text-blue-300">← Back to Team</a>
              <p className="mt-4 text-xs font-semibold uppercase tracking-[0.28em] text-blue-400">Team Manager</p>
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-900 p-6 shadow-xl">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-2xl border border-zinc-700 bg-zinc-800 px-4 py-3 outline-none focus:border-blue-500"
                />
                <button onClick={searchUsers} className="rounded-2xl bg-blue-600 px-5 py-3 font-bold hover:bg-blue-500">
                  Search
                </button>
              </div>
